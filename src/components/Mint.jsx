...
const Mint = () => {
    ...
    return (
        ...
        <div className=" flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10 ">
          ...
          <p className="text-3xl text-white text-gradient"> Voxel Helos Genesis, cabin and fuselage layers added to 
          <br/> the background layer to complete the NFT.</p>
            ...
            <button
              ...
              <p className="text-white text-base font-semibold">
                Mint
                    ...
                    <img src={example} alt="example" className="w-48 mr-1 rounded-xl shadow-[#4dfad7] shadow-lg"/>
                   
                  

                                    </div>
                                        <p className="text-white font-light ml-1 text-sm">
                                        address
                                        </p>
